...
export type SearchVectorInput = z.infer<typeof searchVectorInputSchema>;

export async function searchVectorTool(
  ...
  return http.post(
    `${orgCreds.instanceUrl}/services/data/v66.0/ssot/search-indexes/${input.index_name}/vector`,
